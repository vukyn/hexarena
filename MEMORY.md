...
- [rating tham lam không cầm nổi 2 self-cast](memory/hexarena-a-greedy-rating-cannot-hold-two-self-casts.md) — burrow đè split, 0 lần tách; luôn đo cột "ô trống"
- [rating định giá 0 thì ngừng chơi](memory/hexarena-a-rating-that-prices-nothing-stops-playing.md) — đòn bị pool nuốt = 0 → bỏ lượt mãi; bàn guard phải bất đối xứng
