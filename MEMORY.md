...
- [biên độ không tách được 2 trận, THỜI LƯỢNG thì có](memory/a-magnitude-cannot-separate-two-matchups-a-duration-can.md) — cùng một tier: 248 vs 216 khi không cổng, 222 vs 38 sau cổng; trục là CHỖ NÀO trên thanh máu, không phải độ dài trận
...
- [v0.3.0 + v0.3.1 đã release](memory/hexarena-v0-3-0-released.md) — 63a5e93 / 941f5af; bản ĐẦU TIÊN dùng được không cần checkout (v0.3.1 xong nốt hexforge đọc); ⚠️ chứng minh bằng CHẠY trong thư mục rỗng (dưới pty), không phải bằng install xong
...
- [summon cần KHE giữa format và cap — ĐÃ TÁCH](memory/hexarena-a-summon-needs-a-gap-between-format-and-cap.md) — ENG-013 XONG: BoardSlots(9) vs MaxSquadSize(5), 5v5 mở; ⚠️ số 400 là FIXTURE, harness không commit nên dựng lại ra 462/464/410
