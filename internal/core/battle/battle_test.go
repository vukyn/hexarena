...
func books(t *testing.T) battle.Books {
	...
	statuses, err := status.ParseBook([]byte(`{
	  ...
	  "kinds": [
	    ...
	    {"id": "burrowed", "category": "buff", "max_stacks": 1, "duration": 3},
	    {"id": "sundered", "category": "charge", "max_stacks": 2, "duration": 6},
	    ...
	    {"id": "gangrene", "category": "heal_cut", "max_stacks": 3, "duration": 3,
	     "heal_share": -600},
	    {"id": "mark", "category": "charge", "max_stacks": 5, "duration": 4}
	  ]
	}`))
	if err != nil {
	...
	skills, err := skill.ParseBook([]byte(`{"skills":[
	  ...
	  {"id":"taint","element":"neutral","range":1,"pattern":"single",
	   "power":0,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy",
	   "applies":[{"status":"poison","chance":400}]},
	  {"id":"envenom","element":"neutral","range":1,"pattern":"single",
	   "power":100,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy",
	   "applies":[{"status":"poison","chance":1000}]},
	  {"id":"feint","element":"neutral","range":1,"pattern":"single",
	   "power":100,"strikes":1,"accuracy":1,"cooldown":0,"target":"enemy",
	   "applies":[{"status":"poison","chance":1000}]},
	  ...
	  {"id":"provoke","element":"neutral","range":1,"pattern":"single",
	   "power":10,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy",
	   "applies":[{"status":"taunting","chance":1000}]},
	  {"id":"goad","element":"neutral","range":0,"pattern":"single",
	  ...
	  {"id":"bloodprice","element":"neutral","range":1,"pattern":"single",
	   "power":1000,"strikes":1,"accuracy":300,"cost":200,"cooldown":0,"target":"enemy"},
	  {"id":"ward","element":"neutral","range":0,"pattern":"single",
	   "power":0,"strikes":0,"accuracy":1000,"cooldown":0,"target":"self",
	  ...
	  {"id":"brand","element":"neutral","range":1,"pattern":"single",
	   "power":100,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy",
	   "applies":[{"status":"mark","chance":1000,"stacks":3}]},
	  {"id":"conduit","element":"neutral","range":1,"pattern":"single",
	   "power":300,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy",
	   "requires":{"status":"mark","min_stacks":1,"consume":true,
	    "consume_stacks":1,"arc_power":400}},
	  {"id":"deep","element":"neutral","range":1,"pattern":"single",
	   "power":300,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy",
	   "requires":{"status":"mark","min_stacks":3,"consume":true,
	    "consume_stacks":1,"arc_power":400}},
	  {"id":"nuke","element":"neutral","range":1,"pattern":"single",
	   "power":300,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy",
	   "requires":{"status":"mark","min_stacks":1,"consume":true,
	    "arc_power":200}},
	  {"id":"volley","element":"neutral","range":1,"pattern":"single",
	   "power":150,"strikes":3,"accuracy":1000,"cooldown":0,"target":"enemy",
	   "requires":{"status":"mark","min_stacks":1,"consume":true,
	    "consume_stacks":1,"arc_power":400}},
	  {"id":"flicker","element":"neutral","range":1,"pattern":"single",
	   "power":300,"strikes":1,"accuracy":400,"cooldown":0,"target":"enemy",
	   "requires":{"status":"mark","min_stacks":1,"consume":true,
	    "consume_stacks":1,"arc_power":400}},
	  {"id":"blunt","element":"neutral","range":1,"pattern":"single",
	   "power":380,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy"},
	  {"id":"slam","element":"neutral","range":1,"pattern":"single",
	   "power":1000,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy"},
	  {"id":"patter","element":"neutral","range":1,"pattern":"single",
	   "power":176,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy",
	   "repeat_chance":900,"max_strikes":8},
	  {"id":"once","element":"neutral","range":1,"pattern":"single",
	   "power":700,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy"},
	  {"id":"flurry","element":"neutral","range":1,"pattern":"single",
	   "power":600,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy",
	   "repeat_chance":900,"max_strikes":8},
	  {"id":"scour","element":"neutral","range":1,"pattern":"single",
	   "power":0,"strikes":0,"accuracy":1000,"cooldown":3,"target":"ally",
	   "strips":{"categories":["dot","stat_debuff"],"stacks":1}},
	  {"id":"wipe","element":"neutral","range":1,"pattern":"single",
	   "power":0,"strikes":0,"accuracy":1000,"cooldown":0,"target":"ally",
	   "strips":{"categories":["dot","stat_debuff"],"stacks":1}},
	  {"id":"unmake","element":"neutral","range":1,"pattern":"single",
	   "power":0,"strikes":0,"accuracy":1000,"cooldown":0,"target":"enemy",
	   "strips":{"categories":["shield","regen"],"stacks":3}},
	  ...
	  {"id":"tonic","element":"neutral","range":0,"pattern":"single",
	   "power":0,"strikes":0,"accuracy":1000,"cooldown":0,"target":"self",
	   "restores":900},
	  {"id":"whet","element":"neutral","range":0,"pattern":"single",
	   "power":0,"strikes":0,"accuracy":1000,"cooldown":0,"target":"self",
	   "self_applies":[{"status":"sunder","chance":1000,"stacks":1}]},
	  {"id":"attune","element":"neutral","range":0,"pattern":"single",
	   "power":0,"strikes":0,"accuracy":1000,"cooldown":0,"target":"self",
	   "self_applies":[{"status":"wellspring","chance":1000,"stacks":1}]},
	  ...
	  {"id":"slow_copy","element":"neutral","range":0,"pattern":"single",
	  ...
	  {"id":"call_toad","element":"neutral","range":0,"pattern":"single",
	   ...
	   "summons":{"count":1,"name":"toad","element":"water","skills":["jab"],
	              "stats":{"hp":900,"attack":300,"defense":200,"speed":40,
	                       "accuracy":0,"dodge":0}}},
	  {"id":"split","element":"neutral","range":0,"pattern":"single",
	   "power":0,"strikes":0,"accuracy":1000,"cooldown":0,"target":"self",
	   "self_applies":[{"status":"sundered","chance":1000,"stacks":1}],
	   "self_requires":{"status":"sundered","below_stacks":2,"gates":true},
	   "summons":{"count":1,"name":"half","share":900,"splits":300,"skills":["jab"],
	              "bound":true}},
	  {"id":"arc","element":"neutral","range":1,"pattern":"column",
	   "power":100,"strikes":1,"accuracy":1000,"cooldown":0,"target":"enemy",
	   "applies":[{"status":"poison","chance":1000}]},
	...
	passives, err := passive.ParseBook([]byte(`{"passives":[
	  ...
	  {"id":"enfeebling","grants":[],"applies":[{"status":"weaken","chance":1000}]},
	  {"id":"dazing","grants":[],"applies":[{"status":"stun","chance":1000}]},
	  {"id":"virulent","grants":[],"amplifies":[{"status":"poison","effect":300,"chance":200}]},
	  {"id":"corrosive","grants":[],"amplifies":[{"status":"poison","effect":300}]},
	  {"id":"insidious","grants":[],"amplifies":[{"status":"poison","chance":500}]},
	  {"id":"scalding","grants":[],"amplifies":[{"status":"burn","chance":500}]},
	  {"id":"cornered_venom","grants":[],"while":{"below_health":500},
	   "amplifies":[{"status":"poison","chance":500}]},
	  ...
	  {"id":"dug_in_deep","while":{"below_health":500},
	   "grants":[{"status":"toughened","stacks":1},{"status":"fortified","stacks":1}]},
	  {"id":"first_tier","grants":[{"status":"toughened","stacks":1}]},
	  {"id":"two_tier","grants":[{"status":"toughened","stacks":1},
	   {"status":"fortified","stacks":1,"while":{"above_health":700}}]},
	  {"id":"late_tier","grants":[{"status":"toughened","stacks":1},
	   {"status":"fortified","stacks":1,"while":{"below_health":500}}]},
