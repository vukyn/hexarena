...
q or ctrl+c to quit`,
	...
	BlurbAims:             "Aims at %s.",
	BlurbStrikes:          "%d strikes of %d%% of %s each, %d%% in all",
	BlurbOnce:             "%d%% of %s",
	BlurbPierces:          ", through %d%% of the armour",
	BlurbRestores:         "Heals for %d%% of %s.",
	BlurbDrains:           "Takes back %d%% of the damage it deals.",
	BlurbInflicts:         "Inflicts %s, %d%% of the time.",
	...
	BlurbWhenHurt:         "is at or below %d%% health",
	BlurbAmplified:        "While the target %s: %d%% of %s",
	BlurbConsumes:         ", and eats the %s",
	BlurbCostRange:        "range %d",
	BlurbCostCells:        "%d cells",
	BlurbCostSelf:         "itself",
	BlurbCostAccuracy:     "%d%% to hit",
	...
	BlurbTraitApplies:     "Its attacks also inflict %s, %d%% of the time.",
	BlurbTraitImmune:      "Refuses %s outright.",
	BlurbTraitResists:     "Refuses %d%% of any %s aimed at it.",
	...
	BlurbStatusTicks:      "At the holder's turn, each stack costs %d%% of the applier's stat.",
	BlurbStatusHeals:      "At the holder's turn, each stack restores %d%% of the applier's stat.",
	BlurbStatusLife:       "One stack is %d%% over its life.",
	BlurbStatusLifeCapped: "One stack is %d%% over its life, and %d stacks are %d%%.",
