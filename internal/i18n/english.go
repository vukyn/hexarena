...
q or ctrl+c to quit`,
	...
	SquadsFlagUsage:   "your own squad file",
	...
	CategoryHealMend:    "raises healing received",
	...
	CategoryNounHealMend:   "healing boost",
	...
	PreviewArtNotShipped:   "this program does not carry the pictures — the art lives with the source, not in the binary",
	...
	BlurbWhenUnspent:           "has cast this fewer than %d times",
	...
	BlurbSelfGated:             "Castable only while the caster %s: %s of %s",
	BlurbSelfGatedShape:        "Castable only while this unit %s",
	...
	BlurbConsumesStacks:        ", and eats %d stacks of the %s",
	...
	BlurbConsumesEachStrike:    ", eating %d stacks of the %s per strike",
	BlurbConsumesStacksOne:     ", and eats 1 stack of the %s",
	BlurbConditionInflicts:     ", and also inflicts %s, %s of the time",
	BlurbConsumesEachStrikeOne: ", eating 1 stack of the %s per strike",
	...
	BlurbRestoresPerStack:      ", every stack of %s it spends restores %s of %s as health",
	...
	BlurbTraitWhileAbove:      "In force only at or above %s health.",
	...
	SummarySelfGated:          "needs self %s→%s",
	SummarySelfGatedShape:     "needs self %s",
	SummarySelfScaled:         "self %s→+%s/stack",
	SummarySelfRestored:       "self %s→heals %s/stack",
	...
	BlurbSkillUnstoppable:       ", stopped by neither shield nor barrier",
	...
	BlurbStatusMendsHealing:     "Every heal the holder receives is raised by %s per stack, whatever gave it.",
	BlurbStatusMendsHealingOnce: "Every heal the holder receives is raised by %s, whatever gave it.",
	BlurbStatusPierces:          "The holder's blows ignore %s more of the defence in front of them, per stack.",
	BlurbStatusPiercesOnce:      "The holder's blows ignore %s more of the defence in front of them.",
	BlurbStatusWards:            "The holder refuses %s of every status aimed at it, per stack, whatever it is.",
	BlurbStatusWardsOnce:        "The holder refuses %s of every status aimed at it, whatever it is.",
	...
	StatusesNoCountdown:         "In battle, an effect with no countdown beside it is always in force.",
	...
	SquadForkUnnamed:       "a fork with no arm named",
	SquadForkArms:          "this line forks: %s — ←/→ names one; unnamed, the lists show only the shared part and the save refuses",
	...
	PlayAimSplash:          "%s is a splash cell, at %s",
	PlayBlockedUnknown:     "unknown skill",
	PlayBlockedCooldown:    "%d turns of cooldown left",
	PlayBlockedCooldownOne: "1 turn of cooldown left",
	PlayBlockedFuel:        "needs %d %s, holding %d",
	PlayBlockedSpent:       "all %d uses spent",
	PlayBlockedNoReach:     "nothing in reach",
	...
	PlayNoSaveFooter:       "↑/↓ · enter · ? · a auto · p pass · u undo · [/] scroll · esc",
	PlayOverNoSaveFooter:   "n another battle · [/] scroll · esc back",
...
q or ctrl+c to quit`,
	...
	RefusalNotYourTurn:      "a move, or a draft decision, went out after the turn had gone — usually the clock ran out; nothing of yours was lost, and whatever is on screen now is the right one",
	...
	RefusalSquadUnwanted:    "this room drafts: the two of you ban and pick your sides here, so a squad brought from home is not used; join again with no squad chosen and the banning starts once both players are in",
	RefusalTooManyWatchers:  "this match already has as many people watching as it can carry; wait for one of them to leave and paste the code again, or watch over somebody's shoulder",
	RefusalWatchingClosed:   "this room does not let anybody watch: the host opened it for the two players only, so there is nothing to join here; ask them to host again with watching turned on, or read the board over a player's shoulder",
	...
	ClosedDraftExpired:      "somebody ran out of time while the sides were still banning and picking, so there is no match to play: a draft is never taken up where it stopped, and drafting again means a new room and a new code",
	...
	JoinFooter:   "tab next field · ←/→ squad · ctrl+w watch · enter join · ctrl+l tiếng Việt · esc back",
	...
	WaitingRoom:    "room %s",
	WaitingSeat:    "seat %s",
	WaitingNoSeat:  "watching — no seat",
	...
	PlayLiveReconnecting: "the connection dropped — taking your seat back, the board is still there",
	...
	PlayClockYours:       "your turn %s · them %s",
	PlayClockTheirs:      "you %s · their turn %s",
	PlayWatchWaiting:     "watching — the two of them are deciding",
	PlayWatchFooter:      "[/] scroll · esc stop watching",
	PlayWatchTurnAlly:    "A on turn %s · E %s",
	PlayWatchTurnEnemy:   "A %s · E on turn %s",

	BonusesHeading:    "squad bonuses",
	BonusesSubtitle:   "what a side is paid for what its units share",
	BonusesEmpty:      "no bonuses declared.",
	BonusesFooter:     "↑/↓ move · ctrl+l tiếng Việt · esc back · q quit",
	MenuBonuses:       "squad bonuses",
	MenuBonusesDetail: "the thresholds a squad is paid for, and what each one grants",
	BlurbBonusCounts:  "counts %s",
	BlurbBonusGoesTo:  "goes to %s",
	BlurbBonusRung:    "%d sharing it: %s x%d",
	BlurbBonusCaveat:  "counted once from the squad that walks in, never again — and several may be in force at once",
	...
	JoinWatchLabel: "watch instead of play",
	JoinWatchOn:    "watching — this join takes no seat",
	JoinWatchOff:   "playing — this join takes a seat",
	...
	ArrangeHeading:   "your formation",
	ArrangePlaced:    "%d of %d placed",
	ArrangeDepth:     "Reach is counted in occupied ranks, so whoever stands in a column shields everyone behind them. The column nearest the other half is the front rank.",
	ArrangeAllowance: "Each side is allowed its own time here, and the other side's starts when yours ends.",
	ArrangeInHand:    "%s is waiting for a cell",
	ArrangeUnplaced:  "no cell yet",
	ArrangeSendReady: "enter sends this formation — the room says nothing back until both sides have arranged",
	ArrangeSent:      "Your formation has gone to the room. The other side is still placing, and neither of you is shown the other's until the battle opens.",
	ArrangeLegend:    "%s the cursor · %s the other half — a number is where that pick stands",
	ArrangeCursorAt:  "the cursor is on %s, the %s",
