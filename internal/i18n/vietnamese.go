...
dùng hexforge: cùng dàn
nhân vật, cùng các bước
kiểm tra, cỡ nào cũng
chạy được.
...
q hoặc ctrl+c để thoát`,
	...
	NotATerminal: "đầu ra không phải màn hình terminal, mà chương trình toàn màn hình sẽ đổ mã điều khiển vào đó.\n" +
		"Hãy dùng hexforge: cùng dàn nhân vật, cùng các bước kiểm tra, nhận cờ dòng lệnh và đọc được\n" +
		"pipe; `hexforge check` in ra đúng những gì màn hình kiểm tra ở đây hiển thị",
	DataFlagUsage:     "thư mục dữ liệu để đọc và ghi",
	LanguageFlagUsage: "ngôn ngữ hiển thị: vi hoặc en",

	MenuHeading:            "bạn muốn làm gì?",
	MenuCast:               "dàn nhân vật",
	...
	MenuOrigins:            "nguồn",
	MenuOriginsDetail:      "các tác phẩm mà nhân vật được mượn từ, và thêm tác phẩm mới",
	MenuCheck:              "kiểm tra",
	...
	ColumnArt:           "ảnh",
	ColumnAbsorbs:       "chịu được bao nhiêu của hạn mức, ở trần cấp",
	...
	ErrorIDTaken:            "nhân vật %q đã có trong dàn rồi",
