...
//
// One declaration for all three forms — the skill form here, the character form
// and the origins form in cmd/hexforge-tui — for the reason a passed turn's reason
